...
import { CheckboxProps, Tag } from 'antd';
import { BaseList } from '@app/components/common/BaseList/BaseList';
import { Card } from 'antd';
import { BaseRow } from '@app/components/common/BaseRow/BaseRow';
import { BaseCol } from '@app/components/common/BaseCol/BaseCol';
import { RiFileSearchLine } from 'react-icons/ri';
import { Pagination, ProjectSummaryInfo } from '@app/api/projects.api';
      ...
      <S.CardWrapper>
        <S.Card id="browse" title={t('browse.title')} padding="1.25rem 1.25rem 0">
          <S.SearchRow justify="center" align="middle">
            <S.SearchBar defaultValue={initialQuery} prefix={null} placeholder={t('browse.topSearch.placeholder')} />
          </S.SearchRow>
          <S.SearchRow justify="center" align="middle">
